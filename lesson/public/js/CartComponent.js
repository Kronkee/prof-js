...
Vue.component('cart', {
    ...
    template: `
    <div class="cart">   
              <button class="header__link btn-cart" type="button" @click="showCart = !showCart">
            <svg class="header__link-img" width="33" height="29" viewbox="0 0 33 29" fill="black"
    ...
    <h2 class="cart-block" v-if=" cartItems.length === 0" v-show="showCart">Корзина пуста</h2>
        <div v-else>
    ...
    <div class="cart-item">
        ...
        <div class="product-desc">
            ...
            <div class="changeQuantity">
                <button class="rmv-btn btnInCart" @click="$emit('remove', cartItem)"> &times; </button>
                <p>&#160;{{ cartItem.quantity }}&#160; шт.&#160; </p>
                <button class="add-btn" @click="$emit('add-product', cartItem)"> + </button>
            </div>          
